...
class ReceiverSignals
{
 public:
  ...
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, ConfigureReceiverResponse, std::string, ReceiverConfiguration> > configurereceiver_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, CreateReceiverResponse, ReceiverConfiguration> > createreceiver_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, DeleteReceiverResponse, std::string> > deletereceiver_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, GetReceiverResponse, std::string> > getreceiver_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, GetReceiversResponse> > getreceivers_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, GetReceiverStateResponse, std::string> > getreceiverstate_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, GetServiceCapabilitiesResponse> > getservicecapabilities_;
  std::unique_ptr< Signal<RECEIVEROPERATION, ReceiverClient, SetReceiverModeResponse, std::string, RECEIVERMODE> > setreceivermode_;
