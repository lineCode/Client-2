...
class ReplaySignals
{
 public:
  ...
  std::unique_ptr< Signal<REPLAYOPERATION, ReplayClient, GetReplayUriResponse, StreamSetup, std::string> > getreplayuri_;
  std::unique_ptr< Signal<REPLAYOPERATION, ReplayClient, GetServiceCapabilitiesResponse> > getservicecapabilities_;
