...
Exposure::Exposure(const boost::optional<EXPOSUREMODE>& mode, const boost::optional<EXPOSUREPRIORITY>& priority, const boost::optional<Rectangle>& window, const boost::optional<float>& minexposuretime, const boost::optional<float>& maxexposuretime, const boost::optional<float>& mingain, const boost::optional<float>& maxgain, const boost::optional<float>& miniris, const boost::optional<float>& maxiris, const boost::optional<float>& exposuretime, const boost::optional<float>& gain, const boost::optional<float>& iris) :
  mode_(mode),
  priority_(priority),
  window_(window),
...
Exposure::Exposure(const pugi::xml_node& node)
{
...
std::string Exposure::ToXml(const std::string& name) const
{
...
bool Exposure::operator==(const Exposure& rhs) const
{
