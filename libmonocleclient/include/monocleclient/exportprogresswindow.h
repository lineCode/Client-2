...
class ExportProgressWindow : public QDialog
{
 ...
 private:
  ...
  static void ControlStreamEndCallback(const uint32_t trackid, const uint64_t streamtoken, const uint64_t playrequestindex, const monocle::ErrorCode error, void* callbackdata);
