...
#ifndef IDEPG4GNCYQO5W0Y934829424PS7Z3HTYF
#define IDEPG4GNCYQO5W0Y934829424PS7Z3HTYF
...
class ManageRecordingJobSourceONVIFDiscoveryTree : public QTreeWidget
{
 Q_OBJECT

 public:

  ManageRecordingJobSourceONVIFDiscoveryTree(QWidget* parent);
  ~ManageRecordingJobSourceONVIFDiscoveryTree();
