// manageonvifreceiverdiscoverytreeitem.cpp
//
...
ManageRecordingJobSourceONVIFDiscoveryTreeItem::ManageRecordingJobSourceONVIFDiscoveryTreeItem(const boost::shared_ptr<Device>& device, const std::vector<std::string>& names, const std::vector<std::string>& locations, const std::string& address, const std::string& username, const std::string& password) :
...
ManageRecordingJobSourceONVIFDiscoveryTreeItem::~ManageRecordingJobSourceONVIFDiscoveryTreeItem()
{
  if (onvifmedia_)
  {
    onvifmedia_->Destroy();
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::SetUserPass(const std::string& username, const std::string& password)
{
  username_ = username;
  password_ = password;
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::Collapsed()
{
  connection_.Close();
  if (onvifmedia_)
  {
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::Expanded()
{
  GetProfiles();

}

int ManageRecordingJobSourceONVIFDiscoveryTreeItem::Update()
{
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::RemoveChildren()
{
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::GetProfiles()
{
  connection_.Close();
  if (onvifmedia_)
  {
...
void ManageRecordingJobSourceONVIFDiscoveryTreeItem::SetChildText(const QString& text)
{
  RemoveChildren();
