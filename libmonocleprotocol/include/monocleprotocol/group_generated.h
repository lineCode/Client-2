...
#ifndef FLATBUFFERS_GENERATED_GROUP_MONOCLE_H_
#define FLATBUFFERS_GENERATED_GROUP_MONOCLE_H_
...
struct GroupBuilder {
  ...
  void add_token(uint64_t token) {
    fbb_.AddElement<uint64_t>(Group::VT_TOKEN, token, 0);
  }
  void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    fbb_.AddOffset(Group::VT_NAME, name);
  }
  void add_manageusers(bool manageusers) {
    fbb_.AddElement<uint8_t>(Group::VT_MANAGEUSERS, static_cast<uint8_t>(manageusers), 0);
  }
  void add_managerecordings(bool managerecordings) {
    fbb_.AddElement<uint8_t>(Group::VT_MANAGERECORDINGS, static_cast<uint8_t>(managerecordings), 0);
  }
  void add_allrecordings(bool allrecordings) {
    fbb_.AddElement<uint8_t>(Group::VT_ALLRECORDINGS, static_cast<uint8_t>(allrecordings), 0);
  }
  void add_recordings(flatbuffers::Offset<flatbuffers::Vector<uint64_t>> recordings) {
    fbb_.AddOffset(Group::VT_RECORDINGS, recordings);
  }
  void add_managemaps(bool managemaps) {
    fbb_.AddElement<uint8_t>(Group::VT_MANAGEMAPS, static_cast<uint8_t>(managemaps), 0);
  }
  void add_managedevice(bool managedevice) {
    fbb_.AddElement<uint8_t>(Group::VT_MANAGEDEVICE, static_cast<uint8_t>(managedevice), 0);
  }
...
#endif  // FLATBUFFERS_GENERATED_GROUP_MONOCLE_H_
