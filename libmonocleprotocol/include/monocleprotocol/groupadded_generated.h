...
#ifndef FLATBUFFERS_GENERATED_GROUPADDED_MONOCLE_H_
#define FLATBUFFERS_GENERATED_GROUPADDED_MONOCLE_H_
...
struct GroupAdded;
struct GroupAddedBuilder;

struct GroupAdded FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef GroupAddedBuilder Builder;
...
struct GroupAddedBuilder {
  typedef GroupAdded Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_token(uint64_t token) {
    fbb_.AddElement<uint64_t>(GroupAdded::VT_TOKEN, token, 0);
  }
  void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    fbb_.AddOffset(GroupAdded::VT_NAME, name);
  }
  void add_manageusers(bool manageusers) {
    fbb_.AddElement<uint8_t>(GroupAdded::VT_MANAGEUSERS, static_cast<uint8_t>(manageusers), 0);
  }
  void add_managerecordings(bool managerecordings) {
    fbb_.AddElement<uint8_t>(GroupAdded::VT_MANAGERECORDINGS, static_cast<uint8_t>(managerecordings), 0);
  }
  void add_allrecordings(bool allrecordings) {
    fbb_.AddElement<uint8_t>(GroupAdded::VT_ALLRECORDINGS, static_cast<uint8_t>(allrecordings), 0);
  }
  void add_recordings(flatbuffers::Offset<flatbuffers::Vector<uint64_t>> recordings) {
    fbb_.AddOffset(GroupAdded::VT_RECORDINGS, recordings);
  }
  void add_managemaps(bool managemaps) {
    fbb_.AddElement<uint8_t>(GroupAdded::VT_MANAGEMAPS, static_cast<uint8_t>(managemaps), 0);
  }
  void add_managedevice(bool managedevice) {
    fbb_.AddElement<uint8_t>(GroupAdded::VT_MANAGEDEVICE, static_cast<uint8_t>(managedevice), 0);
  }
  explicit GroupAddedBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<GroupAdded> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<GroupAdded>(end);
    return o;
  }
};

inline flatbuffers::Offset<GroupAdded> CreateGroupAdded(
  ...
  GroupAddedBuilder builder_(_fbb);
...
inline flatbuffers::Offset<GroupAdded> CreateGroupAddedDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t token = 0,
  ...
  return monocle::CreateGroupAdded(
      _fbb,
      token,
      name__,
      manageusers,
...
#endif  // FLATBUFFERS_GENERATED_GROUPADDED_MONOCLE_H_
