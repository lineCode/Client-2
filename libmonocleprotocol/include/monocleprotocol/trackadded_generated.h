...
#ifndef FLATBUFFERS_GENERATED_TRACKADDED_MONOCLE_H_
#define FLATBUFFERS_GENERATED_TRACKADDED_MONOCLE_H_
...
struct TrackAdded FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const monocle::TRACKDATA *> *totaltrackdatas() const {
    return GetPointer<const flatbuffers::Vector<const monocle::TRACKDATA *> *>(VT_TOTALTRACKDATAS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_TOTALTRACKDATAS) &&
           verifier.VerifyVector(totaltrackdatas()) &&
           verifier.EndTable();
  }
};
...
struct TrackAddedBuilder {
  ...
  void add_recordingtoken(uint64_t recordingtoken) {
    fbb_.AddElement<uint64_t>(TrackAdded::VT_RECORDINGTOKEN, recordingtoken, 0);
  }
  void add_id(uint32_t id) {
    fbb_.AddElement<uint32_t>(TrackAdded::VT_ID, id, 0);
  }
  void add_token(flatbuffers::Offset<flatbuffers::String> token) {
    fbb_.AddOffset(TrackAdded::VT_TOKEN, token);
  }
  void add_tracktype(monocle::TrackType tracktype) {
    fbb_.AddElement<int8_t>(TrackAdded::VT_TRACKTYPE, static_cast<int8_t>(tracktype), 0);
  }
  void add_description(flatbuffers::Offset<flatbuffers::String> description) {
    fbb_.AddOffset(TrackAdded::VT_DESCRIPTION, description);
  }
  void add_fixedfiles(bool fixedfiles) {
    fbb_.AddElement<uint8_t>(TrackAdded::VT_FIXEDFILES, static_cast<uint8_t>(fixedfiles), 0);
  }
  void add_digitalsigning(bool digitalsigning) {
    fbb_.AddElement<uint8_t>(TrackAdded::VT_DIGITALSIGNING, static_cast<uint8_t>(digitalsigning), 0);
  }
  void add_encrypt(bool encrypt) {
    fbb_.AddElement<uint8_t>(TrackAdded::VT_ENCRYPT, static_cast<uint8_t>(encrypt), 0);
  }
  void add_flushfrequency(uint32_t flushfrequency) {
    fbb_.AddElement<uint32_t>(TrackAdded::VT_FLUSHFREQUENCY, flushfrequency, 0);
  }
  void add_files(flatbuffers::Offset<flatbuffers::Vector<uint64_t>> files) {
    fbb_.AddOffset(TrackAdded::VT_FILES, files);
  }
  void add_codecindices(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<monocle::CodecIndex>>> codecindices) {
    fbb_.AddOffset(TrackAdded::VT_CODECINDICES, codecindices);
  }
  void add_totaltrackdatatime(uint64_t totaltrackdatatime) {
    fbb_.AddElement<uint64_t>(TrackAdded::VT_TOTALTRACKDATATIME, totaltrackdatatime, 0);
  }
  void add_totaltrackdata(uint64_t totaltrackdata) {
    fbb_.AddElement<uint64_t>(TrackAdded::VT_TOTALTRACKDATA, totaltrackdata, 0);
  }
  void add_totaltrackdatas(flatbuffers::Offset<flatbuffers::Vector<const monocle::TRACKDATA *>> totaltrackdatas) {
    fbb_.AddOffset(TrackAdded::VT_TOTALTRACKDATAS, totaltrackdatas);
  }
  explicit TrackAddedBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<TrackAdded> CreateTrackAdded(
    ...
    flatbuffers::Offset<flatbuffers::Vector<const monocle::TRACKDATA *>> totaltrackdatas = 0) {
  TrackAddedBuilder builder_(_fbb);
  ...
  builder_.add_totaltrackdatas(totaltrackdatas);
...
inline flatbuffers::Offset<TrackAdded> CreateTrackAddedDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t recordingtoken = 0,
    uint32_t id = 0,
    ...
    uint64_t totaltrackdatatime = 0,
    uint64_t totaltrackdata = 0,
    const std::vector<monocle::TRACKDATA> *totaltrackdatas = nullptr) {
  ...
  auto totaltrackdatas__ = totaltrackdatas ? _fbb.CreateVectorOfStructs<monocle::TRACKDATA>(*totaltrackdatas) : 0;
  return monocle::CreateTrackAdded(
      _fbb,
      recordingtoken,
      id,
      token__,
...
#endif  // FLATBUFFERS_GENERATED_TRACKADDED_MONOCLE_H_
