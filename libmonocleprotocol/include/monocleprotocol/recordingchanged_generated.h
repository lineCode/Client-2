...
#ifndef FLATBUFFERS_GENERATED_RECORDINGCHANGED_MONOCLE_H_
#define FLATBUFFERS_GENERATED_RECORDINGCHANGED_MONOCLE_H_
...
struct RecordingChangedBuilder {
  ...
  void add_token(uint64_t token) {
    fbb_.AddElement<uint64_t>(RecordingChanged::VT_TOKEN, token, 0);
  }
  void add_sourceid(flatbuffers::Offset<flatbuffers::String> sourceid) {
    fbb_.AddOffset(RecordingChanged::VT_SOURCEID, sourceid);
  }
  void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    fbb_.AddOffset(RecordingChanged::VT_NAME, name);
  }
  void add_location(flatbuffers::Offset<flatbuffers::String> location) {
    fbb_.AddOffset(RecordingChanged::VT_LOCATION, location);
  }
  void add_description(flatbuffers::Offset<flatbuffers::String> description) {
    fbb_.AddOffset(RecordingChanged::VT_DESCRIPTION, description);
  }
  void add_address(flatbuffers::Offset<flatbuffers::String> address) {
    fbb_.AddOffset(RecordingChanged::VT_ADDRESS, address);
  }
  void add_content(flatbuffers::Offset<flatbuffers::String> content) {
    fbb_.AddOffset(RecordingChanged::VT_CONTENT, content);
  }
  void add_retentiontime(uint64_t retentiontime) {
    fbb_.AddElement<uint64_t>(RecordingChanged::VT_RETENTIONTIME, retentiontime, 0);
  }
  void add_activejob(const monocle::TOKEN *activejob) {
    fbb_.AddStruct(RecordingChanged::VT_ACTIVEJOB, activejob);
  }
  void add_adaptivestreaming(bool adaptivestreaming) {
    fbb_.AddElement<uint8_t>(RecordingChanged::VT_ADAPTIVESTREAMING, static_cast<uint8_t>(adaptivestreaming), 0);
  }
  explicit RecordingChangedBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<RecordingChanged> CreateRecordingChanged(
  ...
  RecordingChangedBuilder builder_(_fbb);
...
inline flatbuffers::Offset<RecordingChanged> CreateRecordingChangedDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t token = 0,
  ...
  return monocle::CreateRecordingChanged(
      _fbb,
      token,
      sourceid__,
      name__,
...
#endif  // FLATBUFFERS_GENERATED_RECORDINGCHANGED_MONOCLE_H_
