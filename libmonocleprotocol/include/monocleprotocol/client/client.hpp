...
class Client : public boost::enable_shared_from_this<Client>
{
 ...
 public:
  ...
  boost::unique_future<ADDRECORDINGRESPONSE> AddRecording(const std::string& sourceid, const std::string& name, const std::string& location, const std::string& description, const std::string& address, const std::string& content, const uint64_t retentiontime, const bool createdefaulttracks);
  ...
  boost::unique_future<CONTROLSTREAMRESPONSE> ControlStream(const uint64_t streamtoken, const uint64_t playrequestindex, const bool fetchmarker, const bool ratecontrol, const bool forwards, const boost::optional<uint64_t>& starttime, const boost::optional<uint64_t>& endtime, const boost::optional<uint64_t>& numframes);
 ...
 protected:
  ...
  boost::system::error_code AddRecordingSend(const std::string& sourceid, const std::string& name, const std::string& location, const std::string& description, const std::string& address, const std::string& content, const uint64_t retentiontime, const bool createdefaulttracks);
  ...
  boost::system::error_code ControlStreamSend(const uint64_t streamtoken, const uint64_t playrequest, const bool fetchmarker, const bool ratecontrol, const bool forwards, const boost::optional<uint64_t>& starttime, const boost::optional<uint64_t>& endtime, const boost::optional<uint64_t>& numframes);
